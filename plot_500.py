...
plt.xlabel('X [km]')
plt.ylabel('Y [km]')
plt.title('SGS simulation+trend, matern covariance, nonstationary, anisotropic 500 m')
plt.colorbar(im, pad=0.03, aspect=40, shrink=0.7, label='bed elevation [meters]')
plt.savefig('figures/matern_nonstationary_500m.png', dpi=300, bbox_inches='tight')
plt.show()